...
<body>
    ...
    <div class="container">
        ...
        <div style="padding: 0;" id="conten">
            <form role="form" action="<?php echo constant("URL") ?>Main/modificarPersona" method="POST">
                <div class="col-md-12" id="conten">
                    <input type="hidden" name="id" id="idpersona" value="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="edad" name="edad" value="<?php echo $this->persona->getEdad(); ?>"  placeholder="Ingresa la edad" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edad">Ingrese el telefono de la persona:</label>
                        <div class="input-group">
                            <input type="tel" class="form-control" id="telefono" name="telefono" value="<?php echo $this->persona->getTelefono(); ?>" placeholder="Ingresa el telefono" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="datetime-local" class="form-control" id="fecha" value="<?php echo $this->persona->getFecha(); ?>" name="fecha" placeholder="Ingresa la fecha" required>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <th><button onclick="alerta('<?php echo $lista->getIdPersona() ?>')" class="btn btn-danger">Eliminar</button></th>
